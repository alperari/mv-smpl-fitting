...
xvfb-run -s "-screen 0 1280x1024x24" \
 ...
 --cam_param data_single_view_mpi/cam.txt \
 --data_folder data_single_view_mpi

# Keypoint detection with AlphaPose

python code/keypoint_predict.py \
 --input_folder data_single_view_mpi/images \
 --keypoint_output_folder data/keypoints \
 --overlay_output_folder output/alphapose
